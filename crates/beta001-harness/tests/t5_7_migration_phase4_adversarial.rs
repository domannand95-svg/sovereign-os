...
#[test]
fn migration_parity_adv_001_contained_forbidden() {
    assert_migration_parity(
        "fixtures/adversarial/adv_001_contained_forbidden.json",
        "fixtures/corpus/scenario_adv_001_contained_forbidden.json",
    );
}

#[test]
fn migration_parity_adv_002_tool_unavailable() {
    assert_migration_parity(
        "fixtures/adversarial/adv_002_tool_unavailable.json",
        "fixtures/corpus/scenario_adv_002_tool_unavailable.json",
    );
}
