...
impl CapabilityLifecycleEngine {
    ...
    pub fn revoke_token(
        ...
        match record.state {
            TokenLifecycleState::Minted => {
                record.state = TokenLifecycleState::Revoked { revoked_at, reason };
...
mod capability_lifecycle_tests {
    ...
    fn lif_01_mint_to_consumption_flow() {
        ...
        assert_eq!(
            ...
            Some(&TokenLifecycleState::Minted)
        );
    ...
    fn lif_03_consumed_token_cannot_be_revoked() {
        ...
        engine
            .consume_token("cap_tok_03", "rcpt_03".into(), 1710000010)
            .unwrap();
    ...
    fn lif_04_revoked_token_cannot_be_consumed() {
        ...
        engine
            .revoke_token("cap_tok_04", "Security alert".into(), 1710000010)
            .unwrap();
